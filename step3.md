...
Ok, so what if we could SAVE programs... and LOAD them back? I'm speaking of course about magnetic tapes here, [cassettes], yeah those things. Are you still with me? Great!
...
Next, you need to update your emulator and add the TAPE cassette recorder to the `ZxSpectrum` struct... emulated, of course. You can also add a boolean flag if you want to optionally hear the TAPE sound being played or recorded.
...
The cloning part was delegated to the [From] implementation, which now looks like this:
